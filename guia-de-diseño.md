# Guía de Diseño — SportFlow / Olympia
> Plataforma de logística deportiva · Landing Page

---

## 0. Configuración de Tailwind CSS con CDN (Vue.js)

> Usa este bloque en el `<head>` de tu archivo `index.html`. El script de configuración **debe ir antes** del CDN de Tailwind.

```html
<!-- ✅ 1. Primero: configuración de colores personalizados -->
<script>
  tailwind.config = {
    theme: {
      extend: {
        colors: {
          primary:   '#2563EB',   // Azul principal — botones CTA, logo, gradientes
          'primary-dark': '#1d4ed8', // Hover del botón primario
          secondary: '#06B6D4',   // Cian — íconos, badges, etiquetas
          dark:      '#0F172A',   // Header, footer, fondo dark
        },
        fontFamily: {
...
<!-- ✅ 2. Después: CDN de Tailwind -->
<script src="https://cdn.tailwindcss.com"></script>

<!-- ✅ 3. Fuente Inter desde Google Fonts -->
<link rel="preconnect" href="https://fonts.googleapis.com" />
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet" />
```

### Cómo usar los colores en tus clases de Tailwind

Una vez configurado, puedes usar los colores con el nombre que definiste:

| Clase Tailwind | Color aplicado | Ejemplo de uso |
|---|---|---|
| `bg-primary` | `#2563EB` | Fondo del botón CTA |
| `bg-primary-dark` | `#1d4ed8` | Hover del botón CTA |
| `text-primary` | `#2563EB` | Texto en azul primario |
| `bg-secondary` | `#06B6D4` | Fondo de íconos (con opacidad) |
| `text-secondary` | `#06B6D4` | Color de íconos y badges |
| `bg-dark` | `#0F172A` | Fondo del header y footer |
| `text-dark` | `#0F172A` | Texto principal sobre fondos claros |
| `font-sans` | Inter | Tipografía base |

### Ejemplo de botón CTA en Vue

```html
<button
  class="bg-primary hover:bg-primary-dark text-white font-bold px-10 py-4 rounded-full transition-all duration-300 hover:scale-105"
>
  Registrarse ahora →
</button>
```

### Ejemplo de ícono con fondo cian en Vue

```html
<!-- Contenedor del ícono -->
<div class="w-20 h-20 rounded-2xl bg-secondary/10 flex items-center justify-center">
  <!-- Ícono SVG o componente con text-secondary -->
  <svg class="w-9 h-9 text-secondary" ...></svg>
</div>
```

### Ejemplo de header oscuro en Vue

```html
<header class="bg-dark sticky top-0 z-50 px-6 py-4">
  <span class="text-white font-bold">
    Sport<span class="text-secondary">Flow</span>
  </span>
</header>
```

### Estructura base del `index.html` para Vue + Tailwind CDN
...
> **⚠️ Importante:** El CDN de Tailwind es ideal para prototipos y proyectos pequeños. Para producción se recomienda instalar Tailwind con npm y usar PurgeCSS para reducir el tamaño del CSS final.
